...
description: 本地知识库 RAG 工具，用于对本地文件夹中的文档进行向量化索引和语义检索问答。当用户提到"知识库"、"从我的知识库查"、"查一下我之前记录的"、"我的笔记里有没有"、"从文档里找答案"、"帮我搜一下之前的记录"等意图时，必须使用此 skill。适用场景包括但不限于：用户想查询自己积累的知识、想从本地文档中检索信息、想建立文档索引、想纠正 AI 的回答（FQA）、想增量更新或重建知识库。关键触发词：知识库、文档检索、语义搜索、向量检索、RAG、文档问答、知识管理、我的笔记、我之前记录的、从文档里查、帮我找一下之前的解决方案。即使用户没有明确说"知识库"三个字，只要语义上是在检索自己积累的本地知识或文档内容，就应该触发此 skill。
---
